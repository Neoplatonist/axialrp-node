...
module.exports = [
  {
    ...
    'name': 'Conjuration',
    'description': 'Conjuration spells involve the transportation of objects and creatures from one location to another. Some spells summon creatures or objects to the casterâ€™s side, whereas others allow the caster to teleport to another location. Some conjurations create objects or effects out of nothing.'
  },{
    'name': 'Divination',
    ...
    'name': 'Transmutation',
    'description': 'Transmutation spells change the properties of a creature, object, or environment. They might turn an enemy into a harmless creature, bolster the strength of an ally, make an object move at the casterâ€™s command, or enhance a creatureâ€™s innate healing abilities to rapidly recover from injury.'
  }
]